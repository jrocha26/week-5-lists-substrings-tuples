...
#insert adds to certain index
print(my_list)
my_list.insert(1, "bubble")
print(my_list)

my_list1=["water", "bubbles", "fire"]
my_list2=["july", "terrence", "jugga", "star trek"]
#join both lists in a new variable 
...
newList2.insert(21, "water")
print(newList2)
newList2.insert(22, "fire")
print(newList2)
newList2.insert(23, "ice")
print(newList2)
